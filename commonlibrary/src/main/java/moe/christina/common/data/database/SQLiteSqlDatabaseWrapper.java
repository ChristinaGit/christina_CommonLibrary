package moe.christina.common.data.database;
...
public abstract class SQLiteSqlDatabaseWrapper extends SQLiteOpenHelper implements SqlDatabase {
    @Override
    ...
    protected SQLiteSqlDatabaseWrapper(
